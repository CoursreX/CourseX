...
INSERT INTO STUDENT (STUDENT_ID, MAJOR_ID, STUDENT_PW, STUDENT_NAME, STUDENT_EMAIL, STUDENT_SEM, CREDIT_LIMIT, EMAIL_VERIFY_CODE, EMAIL_VERIFY_DATE) VALUES ('S001', 'M001', '0000', '눈송이', 'example@sm.ac.kr', 7, 10, null, null);
