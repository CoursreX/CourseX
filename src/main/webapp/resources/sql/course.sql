...
INSERT INTO COURSE (COURSE_ID, COURSE_NO, FACULTY_ID, COURSE_NAME, COURSE_CREDIT, COURSE_CAP, COURSE_DAY, COURSE_TIME, COURSE_ROOM, COURSE_CATEGORY, COURSE_ENROLLED, IS_EXPANDED, IS_OPENED) VALUES ('C014', 2, 'F004', '프로그래밍개론', 3, 70, '화,목', '10:30-11:45', '프라임관203','전공', 0, 'CA023', 0);
INSERT INTO COURSE (COURSE_ID, COURSE_NO, FACULTY_ID, COURSE_NAME, COURSE_CREDIT, COURSE_CAP, COURSE_DAY, COURSE_TIME, COURSE_ROOM, COURSE_CATEGORY, COURSE_ENROLLED, IS_EXPANDED, IS_OPENED) VALUES ('C014', 3, 'F004', '프로그래밍개론', 3, 70, '월,수', '13:30-14:45', '프라임관204','전공', 0, 'CA024', 0);
