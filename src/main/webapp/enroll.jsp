...
<div class="content__left">
    <form class="search__filter" onchange="handleRadio(event)">
        <div class="search__radio" onclick="handleRadioClick(event)">
        ...
        <div class="search__filter__element" id="searchCodeInput" style="display: none;">
            <label for="code">과목코드</label>
            <input type="text" id="code" name="code" placeholder="과목코드 입력">
            <button type="submit">검색</button>
        </div>
        <div class="search__filter__element" id="searchNameInput" style="display: none;">
            <label for="name">과목명</label>
            <input type="text" id="name" name="name" placeholder="과목명 입력">
            <button type="submit">검색</button>
        </div>
        <div class="search__filter__element" id="searchCategorySelect" style="display: none;">
